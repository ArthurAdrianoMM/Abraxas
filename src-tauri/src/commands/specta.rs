...
pub fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            super::models::pick_gguf_file,
            super::models::import_local_model,
            super::models::resolve_model_source,
            super::models::start_url_download,
            super::models::set_model_chat_template,
